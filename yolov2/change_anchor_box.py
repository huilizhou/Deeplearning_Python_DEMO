...
def kmeans(X, centroids, eps, anchor_file, input_shape, yolo_version):
    ...
    while True:
        ...
        print("iter {}: dists = {}".format(
            iter, np.sum(np.abs(old_D-D))))  # 计算每次迭代和前一次IoU的变化值
...
def main(argv):
    ...
    parser.add_argument('-filelist', default=r'C:\Users\huili\Desktop\yolov2\2020_train.txt',
                        help='path to filelist\n')
    parser.add_argument('-output_dir', default=r'C:\Users\huili\Desktop\yolov2', type=str,
    ...
    if args.num_clusters == 0:
        for num_clusters in range(1, 11):  # we make 1 through 10 clusters
            ...
            kmeans(annotation_dims, centroids, eps, anchor_file,
                   args.yolo_input_shape, args.yolo_version)
